...
#import <float.h>
#import "UIColor+ZGColor.h"
#import "UIImage+ZGImageEffects.h"
...
{
    UIColor *tintColor = [UIColor zg_lightEffectColor];
    return [self zg_applyBlurWithRadius:30.0f tintColor:tintColor saturationDeltaFactor:1.8f maskImage:nil];
}


- (UIImage *)zg_applyExtraLightEffect
{
    UIColor *tintColor = [UIColor zg_extraLightEffectColor];
    return [self zg_applyBlurWithRadius:20.0f tintColor:tintColor saturationDeltaFactor:1.8f maskImage:nil];
}


- (UIImage *)zg_applyDarkEffect
{
    UIColor *tintColor = [UIColor zg_darkEffectColor];
    return [self zg_applyBlurWithRadius:20.0f tintColor:tintColor saturationDeltaFactor:1.8f maskImage:nil];
}
...
- (UIImage *)zg_applyTintEffectWithColor:(UIColor *)tintColor
{
    ...
    return [self zg_applyBlurWithRadius:10 tintColor:effectColor saturationDeltaFactor:-1.0 maskImage:nil];
}
