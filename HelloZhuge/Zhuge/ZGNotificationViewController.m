...
#import "UIImage+ZGAverageColor.h"
...
@interface ZGNotificationViewController ()

@end

@implementation ZGNotificationViewController
...
@interface ZGTakeoverNotificationViewController () {
    CGPoint _viewStart;
    BOOL _touching;
}
...
@implementation ZGTakeoverNotificationViewController
...
@interface ZGMiniNotificationViewController () {
...
@implementation ZGMiniNotificationViewController
...
- (void)viewDidLoad
{
    ...
    UIColor *backgroundColor = [UIColor zg_applicationPrimaryColor];
    if (!backgroundColor) {
        backgroundColor = [UIColor zg_darkEffectColor];
    }
